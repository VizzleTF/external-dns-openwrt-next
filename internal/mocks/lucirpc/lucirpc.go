...
// Source: github.com/VizzleTF/external-dns-openwrt-webhook/pkg/lucirpc (interfaces: LuciRPC)
//
// Generated by this command:
//
//	mockgen -destination=internal/mocks/lucirpc/lucirpc.go -package=mocks github.com/VizzleTF/external-dns-openwrt-webhook/pkg/lucirpc LuciRPC
//
...
func (m *MockLuciRPC) Sys(arg0 context.Context, arg1 string, arg2 []string) (string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Sys", arg0, arg1, arg2)
	ret0, _ := ret[0].(string)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockLuciRPCMockRecorder) Sys(arg0, arg1, arg2 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Sys", reflect.TypeOf((*MockLuciRPC)(nil).Sys), arg0, arg1, arg2)
}
